...
doc_events = {
    ...
    "Sales Order": {
        "on_update": "tax_before_discount.tax_before_discount.overrides.sales_order.calculate_tax_before_discount"
    },
    "Delivery Note": {
...
fixtures = [
    {
        "dt": "Custom Field",
        "filters": [
            ["dt", "in", ["Sales Order Item", "Delivery Note Item", "Pricing Rule", "Customer"]],
            ["fieldname", "in", ["discount_account", "taxes_and_charges"]]
        ]
    }
]
# Apps
